...
public abstract class Backend
{
    ...
    /**
     * Process the intermediate code and the symbol table generated by the
     * parser for a certain function with its own iCode root node
     * @param iCode the intermediate code.
     * @param symTabStack the symbol table stack.
     * @param objectFilePath the object file path for the generated code.
     * @param functionId symbol table for this function
     * @throws Exception if an error occurred.
     */
    public abstract void processFunction(ICode iCode, SymTabStack symTabStack,
            String objectFilePath, SymTabEntry functionId) 
        throws IOException;
}
